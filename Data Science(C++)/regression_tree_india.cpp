...
int main()
{
    ...
    {
        {"pregancies",inputCol,numericData,0,17,18,NULL},
        {"glucose",inputCol,numericData,0,199,200,NULL},
        {"pressure",inputCol,numericData,0,122,123,NULL},
        {"thickness",inputCol,numericData,0,99,100,NULL},
        {"insulin",inputCol,numericData,0.08,2.42,3,NULL},
        {"bmi",inputCol,numericData,0,846,847,NULL},
        {"pedigree",inputCol,numericData,0.08,2.42,3,NULL},
        {"age",inputCol,numericData,21,81,60,NULL},
        {"decision",outputCol,numericData,0,1,2,NULL}
    };

    NumericDataSet dataSet(9,metas);
    dataSet.addData("diabetes_india.csv");
    NumericDataSet** sets = dataSet.TrainTestSplit(0.75);
    RegressionTree* tree = new RegressionTree(*sets[0],19,5);
    tree->train();
    tree->evaluate(sets);
    return 0;
}
