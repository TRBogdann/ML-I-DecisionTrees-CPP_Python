...
{  
    ...
    {
        {"gender",inputCol,atrib},
        {"age",inputCol,numericData},
        {"hypertension",inputCol,numericData},
        {"heart_disease",inputCol,numericData},
        {"smoking_history",inputCol,atrib},
        {"bmi",inputCol,numericData},
        {"HbA1c_level",inputCol,numericData},
        {"blood_glucose_level",inputCol,numericData},
        {"decision",outputCol,atrib}
    };
    DataSet set(9,metas);
    set.addData("diabetes_prediction_dataset.csv");
